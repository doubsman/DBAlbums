...
class Ui_ParamsJson(object):
    def setupUi(self, ParamsJson):
        ...
        self.label_general = QtWidgets.QLabel(ParamsJson)
        ...
        self.horizontalLayout_combo.addWidget(self.lab_envt)
    ...
    def retranslateUi(self, ParamsJson):
        ...
        self.label_general.setText(_translate("ParamsJson", "General"))
