...
class Ui_ParamsJson(object):
    def setupUi(self, ParamsJson):
        ...
        self.label_libfamily = QtWidgets.QLabel(ParamsJson)
        self.label_libfamily.setAlignment(QtCore.Qt.AlignCenter)
        self.label_libfamily.setObjectName("label_libfamily")
        self.verticalLayout_environments.addWidget(self.label_libfamily)
        self.tableWidget_family = QtWidgets.QTableWidget(ParamsJson)
        self.tableWidget_family.setObjectName("tableWidget_family")
        self.tableWidget_family.setColumnCount(0)
        self.tableWidget_family.setRowCount(0)
        self.verticalLayout_environments.addWidget(self.tableWidget_family)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.textEdit_cate.sizePolicy().hasHeightForWidth())
        self.textEdit_cate.setSizePolicy(sizePolicy)
        ...
        self.btn_load = QtWidgets.QPushButton(ParamsJson)
        self.btn_load.setObjectName("btn_load")
        self.horizontalLayout_menu.addWidget(self.btn_load)
    ...
    def retranslateUi(self, ParamsJson):
        ...
        self.btn_load.setText(_translate("ParamsJson", "Load Config"))
        self.btn_save.setText(_translate("ParamsJson", "Save Config"))
