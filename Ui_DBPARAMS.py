...
class Ui_ParamsJson(object):
    def setupUi(self, ParamsJson):
        ...
        self.btn_supenvt = QtWidgets.QPushButton(ParamsJson)
        self.btn_supenvt.setObjectName("btn_supenvt")
        self.horizontalLayout_combo.addWidget(self.btn_supenvt)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_cate.sizePolicy().hasHeightForWidth())
        self.label_cate.setSizePolicy(sizePolicy)
        self.label_cate.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.label_cate.setAlignment(QtCore.Qt.AlignCenter)
        self.label_cate.setObjectName("label_cate")
        self.horizontalLayout.addWidget(self.label_cate)
        self.btn_supcate = QtWidgets.QPushButton(ParamsJson)
        self.btn_supcate.setObjectName("btn_supcate")
        self.horizontalLayout.addWidget(self.btn_supcate)
    ...
    def retranslateUi(self, ParamsJson):
        ...
        self.label_libgeneral.setText(_translate("ParamsJson", "General"))
        self.label_libenvt.setText(_translate("ParamsJson", "Environment"))
        self.btn_supenvt.setText(_translate("ParamsJson", "Del"))
        self.btn_addenvt.setText(_translate("ParamsJson", "Add"))
        self.label_libcate.setText(_translate("ParamsJson", "Category"))
        self.label_cate.setText(_translate("ParamsJson", "Category"))
        self.btn_supcate.setText(_translate("ParamsJson", "Del"))
